package biz.riverone.tsumorikinen.common;
...
public abstract class MyPagerAdapterBase<T> extends PagerAdapter {
    private ArrayList<IdentifiedItem<T>> items;
    private final Object lock = new Object();
    private final IdentifiedItemFactory<T> identifiedItemFactory;

    @SuppressWarnings("WeakerAccess")
    public MyPagerAdapterBase() {
        this(new ArrayList<T>());
    }

    @SuppressWarnings("unused")
    @SafeVarargs
    public MyPagerAdapterBase(T... items) {
        this(new ArrayList<>(Arrays.asList(items)));
    }

    @SuppressWarnings("WeakerAccess")
    public MyPagerAdapterBase(List<T> items) {
    ...
    private static class IdentifiedItemFactory<T> {
        private long lastId;
